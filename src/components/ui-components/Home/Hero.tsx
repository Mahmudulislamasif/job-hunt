      ...
      >
        <div className="container mx-auto py-10 md:py-20">
          <div className="px-4 md:p-0 ">
            <h1 className="text-[40px] pt-12 font-medium">
              <span className="text-secondary">3,000+ </span>Browse Jobs
            </h1>
            ...
            <div className="pb-10">
              <ul className="flex gap-3 flex-wrap">
                <li className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">Trending Keywords :</span>
                </li>
                <li>
              ...
              {featureJobs.map((link, index) => (
                ...
                >
                  <div className="text-center py-10">
                    ...
                    <p className="font-normal text-[16px] opacity-65">
                      ({link.totalJobs})
                    </p>
                  </div>
                </div>
